...
package com.windy.musi.common.feign.sentinel.ext;
 ...
 * @date 2020/6/9
 */
public final class MusiSentinelFeign {

	private MusiSentinelFeign() {

	}

	public static MusiSentinelFeign.Builder builder() {
		return new MusiSentinelFeign.Builder();
	}
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		@Override
		public MusiSentinelFeign.Builder contract(Contract contract) {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new MusiSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new MusiSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new MusiSentinelInvocationHandler(target, dispatch);
				}
