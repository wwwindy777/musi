 ...
 */
@Slf4j
public class MusiSentinelInvocationHandler implements InvocationHandler {
	...
	MusiSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			MusiSentinelInvocationHandler other = (MusiSentinelInvocationHandler) obj;
