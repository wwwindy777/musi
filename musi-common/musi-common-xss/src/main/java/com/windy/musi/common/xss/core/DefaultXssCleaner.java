...
package com.windy.musi.common.xss.core;

import cn.hutool.core.util.CharsetUtil;
import com.windy.musi.common.xss.config.MusiXssProperties;
import com.windy.musi.common.xss.utils.XssUtil;
...
public class DefaultXssCleaner implements XssCleaner {
	...
	private final MusiXssProperties properties;

	public DefaultXssCleaner(MusiXssProperties properties) {
		this.properties = properties;
	}

	private static Document.OutputSettings getOutputSettings(MusiXssProperties properties) {
	...
	public String clean(String bodyHtml, XssType type) {
		...
		MusiXssProperties.Mode mode = properties.getMode();
		if (MusiXssProperties.Mode.escape == mode) {
			// html 转义
			return HtmlUtils.htmlEscape(bodyHtml, CharsetUtil.UTF_8);
		}
		else if (MusiXssProperties.Mode.validate == mode) {
			// 校验
