...
package com.windy.musi.common.log.event;
...
import com.windy.musi.admin.api.feign.RemoteLogService;
import com.windy.musi.common.core.constant.SecurityConstants;
import com.windy.musi.common.core.jackson.MusiJavaTimeModule;
import com.windy.musi.common.log.config.MusiLogProperties;
...
public class SysLogListener implements InitializingBean {
	...
	private final MusiLogProperties logProperties;
	...
	public void afterPropertiesSet() {
		...
		objectMapper.registerModule(new MusiJavaTimeModule());
	}
